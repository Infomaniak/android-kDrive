...
class SelectIntervalTypeBottomSheetDialog : SelectBottomSheetDialog() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        selectRecyclerView.adapter = SelectIntervalTypeBottomSheetAdapter(syncSettingsViewModel.syncIntervalType.value!!) {
            syncSettingsViewModel.syncIntervalType.value = it
            dismiss()
        }
    }
