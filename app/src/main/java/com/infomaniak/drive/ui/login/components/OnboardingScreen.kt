...
import com.infomaniak.core.onboarding.HorizontalPagerIndicatorDefaults
...
fun OnboardingScreen(
    ...
    OnboardingScaffold(
        ...
        indicatorStyle = HorizontalPagerIndicatorDefaults.style(inactiveColor = colorResource(R.color.border))
    )

    if (showAccountsBottomSheet) {
        val sheetState = rememberModalBottomSheetState()
        // TODO: Make a kDrive bottom sheet in compose
        ModalBottomSheet(sheetState = sheetState, onDismissRequest = { showAccountsBottomSheet = false }) {
            CrossLoginListAccounts(
                ...
                onSaveClicked = {
                    ...
                    coroutineScope.launch { sheetState.hide() }.invokeOnCompletion { showAccountsBottomSheet = false }
                },
            )
        }
    }
