...
open class FileListFragment : MultiSelectFragment(MATOMO_CATEGORY), SwipeRefreshLayout.OnRefreshListener {
    ...
    companion object {
        ...
        const val MATOMO_CATEGORY = "fileList"
    }
    ...
    private fun setupMultiSelect() {
        multiSelectManager.enabledMultiSelectMode = true
        ...
        multiSelectLayout?.apply {
            ...
            selectAllButton.apply {
                ...
                setOnClickListener {
                    ...
                    if (multiSelectManager.allSelected) {
    ...
    private fun onUpdateMultiSelect(selectedNumber: Int? = null) {
        ...
        val textId = if (multiSelectManager.allSelected) R.string.buttonDeselectAll else R.string.buttonSelectAll
    ...
    override fun getSelectedFilesCount(): Int? {
        return if (multiSelectManager.allSelected) fileListViewModel.lastItemCount?.count ?: fileAdapter.itemCount else null
    }
