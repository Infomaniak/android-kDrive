...
import kotlinx.android.synthetic.main.cardview_media_folder.view.*
...
class MediaFoldersAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.cardview_media_folder, parent, false)
    )
